...
import type { ManifestCache, SystemRepository, TenantBindingVerifier } from "../src/modules/runtime-manifest/ports.js";
...
describe("dependency failure and recovery fixtures", () => {
  it("fails closed on Redis outage and serves after Redis recovery", async () => {
    ...
    const service = new RuntimeManifestService(repository, cache, { verify: async () => undefined } satisfies TenantBindingVerifier);
