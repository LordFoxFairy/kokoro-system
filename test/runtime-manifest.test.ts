...
import type { ManifestCache, SiteHostResolver, SystemRepository } from "../src/modules/runtime-manifest/ports.js";
...
it("keeps surface-specific manifests separate from the default manifest cache entry", async () => {
  ...
  const hostResolver: SiteHostResolver = { verify: async () => undefined };
